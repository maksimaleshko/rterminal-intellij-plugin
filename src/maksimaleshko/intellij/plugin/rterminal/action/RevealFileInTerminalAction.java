 ...
 */
package maksimaleshko.intellij.plugin.rterminal.action;
...
import maksimaleshko.intellij.plugin.rterminal.RTerminalToolWindowFactory;
import maksimaleshko.intellij.plugin.rterminal.RTerminalView;
...
public class RevealFileInTerminalAction extends DumbAwareAction {
  ...
  public void actionPerformed(AnActionEvent e) {
    ...
    ToolWindow window = ToolWindowManager.getInstance(project).getToolWindow(RTerminalToolWindowFactory.TOOL_WINDOW_ID);
    if (window != null && window.isAvailable()) {
      RTerminalView.getInstance(project).setFileToOpen(selectedFile);

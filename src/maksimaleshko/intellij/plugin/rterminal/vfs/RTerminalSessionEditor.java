 ...
 * @author traff
 */
public class RTerminalSessionEditor extends UserDataHolderBase implements FileEditor {

  private final Project myProject;
  private final RTerminalSessionVirtualFileImpl myFile;
  private final TtyConnectorWaitFor myWaitFor;

  public RTerminalSessionEditor(Project project, @NotNull RTerminalSessionVirtualFileImpl terminalFile) {
    myProject = project;
    myFile = terminalFile;

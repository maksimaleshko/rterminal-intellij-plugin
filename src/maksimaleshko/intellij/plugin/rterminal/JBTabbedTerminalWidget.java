...
//        @Override
    ...
    private TabInfo createTabInfo(String name, JediTermWidget terminal) {
      ...
      return tabInfo
        .setObject(new RTerminalSessionVirtualFileImpl(tabInfo, terminal, mySettingsProvider));
    }
    ...
    class MyDragOutDelegate implements TabInfo.DragOutDelegate {
      ...
      private RTerminalSessionVirtualFileImpl myFile;
      ...
      public void dragOutStarted(MouseEvent mouseEvent, TabInfo info) {
        ...
        myFile = (RTerminalSessionVirtualFileImpl)info.getObject();

...
import maksimaleshko.intellij.plugin.rterminal.vfs.RTerminalSessionVirtualFileImpl;
 ...
 * @author traff
 */
public class RTerminalView {
  private final static String TERMINAL_FEATURE = "rterminal";
  ...
  public RTerminalView(Project project) {
    myProject = project;
  }

  public static RTerminalView getInstance(@NotNull Project project) {
    return project.getComponent(RTerminalView.class);
  }
  ...
  public void initTerminal(final ToolWindow toolWindow) {
    ...
    ((ToolWindowManagerEx)ToolWindowManager.getInstance(myProject)).addToolWindowManagerListener(new ToolWindowManagerListener() {
      ...
      public void stateChanged() {
        ToolWindow window = ToolWindowManager.getInstance(myProject).getToolWindow(RTerminalToolWindowFactory.TOOL_WINDOW_ID);
        if (window != null) {
...
//    myProject.getMessageBus().connect().subscribe(topic, new ToolWindowManagerListener() {
////      @Override
...
//    });
  ...
  private Content createTerminalInContentPanel(@NotNull AbstractTerminalRunner terminalRunner,
    ...
    RTerminalToolWindowPanel panel = new RTerminalToolWindowPanel(PropertiesComponent.getInstance(myProject), toolWindow);
  ...
  public class TerminalDockContainer implements DockContainer {
    ...
    public void add(@NotNull DockableContent content, RelativePoint dropTarget) {
      if (isTerminalSessionContent(content)) {
        RTerminalSessionVirtualFileImpl terminalFile = (RTerminalSessionVirtualFileImpl)content.getKey();
    ...
    private boolean isTerminalSessionContent(DockableContent content) {
      return content.getKey() instanceof RTerminalSessionVirtualFileImpl;
    }
...
class RTerminalToolWindowPanel extends SimpleToolWindowPanel implements UISettingsListener {
  private final PropertiesComponent myPropertiesComponent;
  private final ToolWindow myWindow;

  public RTerminalToolWindowPanel(PropertiesComponent propertiesComponent, ToolWindow window) {
    super(false, true);

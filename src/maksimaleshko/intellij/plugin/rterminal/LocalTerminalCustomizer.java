...
public abstract class LocalTerminalCustomizer {
  public static ExtensionPointName<LocalTerminalCustomizer> EP_NAME = ExtensionPointName.create("maksimaleshko.intellij.plugin.rterminal.localTerminalCustomizer");

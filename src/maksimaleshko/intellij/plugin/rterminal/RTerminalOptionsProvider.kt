...
@State(name = "RTerminalOptionsProvider", storages = [(Storage("rterminal.xml"))])
class RTerminalOptionsProvider : PersistentStateComponent<RTerminalOptionsProvider.State> {
  ...
  companion object {
    val instance: RTerminalOptionsProvider
      get() = ServiceManager.getService(RTerminalOptionsProvider::class.java)
  }
}
